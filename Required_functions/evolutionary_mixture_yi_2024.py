...
if __name__ == "__main__":
    ...
    fit, chosen_spec = evolutionary_lwm_fit(
        ...
        wald_q=1,
        weights=None,
        fixed_M = 3, #Total number of mixtures. If these are explicitely set, then the evolutionary algorithmn is not run, and the fixed mixtures are used
        fixed_M1=0, ###of lognormals
