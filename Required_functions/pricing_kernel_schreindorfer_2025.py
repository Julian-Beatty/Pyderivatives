...
def compute_rra_for_all_dates(
    ...
    *, 
    ...
    """
    Same as before, but now ALSO computes:
      - gamma_power_by_T (CRRA slope from lnM vs lnR)
      - a_exponential_by_T (CARA slope from lnM vs R)
      - and their intercepts alpha_*
    """
    result: Dict[str, Dict[str, Any]] = {}

    for date_key, pack in pricing_kernel_information.items():
