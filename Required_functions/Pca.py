...
if __name__ == "__main__":
    ...
    m_candidates = [23,46,66]  # can be any array-like of integers Selects the number of mixture using Cross validation.
    ...
    fit, m_best = lpca_fit_select_m(
        ...
        pad=1.2,
        lambda_eq=0.0,    # you can turn these back on if you like not needed.
        l2_reg=0.0  # grid for density comparison set to zero, regularization rarely needed
    )
